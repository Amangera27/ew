      ...
      <div className="flex-grow w-full max-w-5xl mx-auto px-6 pt-36 md:pt-44 pb-16 relative z-10">
        <div className="bg-white rounded-[2rem] p-8 md:p-16 shadow-[0_20px_60px_rgba(0,0,0,0.05)] border border-gray-100">
          ...
          <div className="prose prose-lg text-gray-700 max-w-none">
            ...
            <p>Welcome to Energy Warehouse. By accessing or using our platform, you agree to be bound by these terms and conditions.</p>
            
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">1. Acceptance of Terms</h2>
            <p>Dummy text for terms and conditions. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">3. Service Availability</h2>
