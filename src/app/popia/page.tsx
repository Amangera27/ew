    ...
    <main className="bg-[#f8fafc] min-h-screen flex flex-col">
      ...
      <div className="flex-grow w-full max-w-5xl mx-auto px-6 pt-36 md:pt-44 pb-16 relative z-10">
        <div className="bg-white rounded-[2rem] p-8 md:p-16 shadow-[0_20px_60px_rgba(0,0,0,0.05)] border border-gray-100">
          <h1 className="text-4xl md:text-5xl font-black text-[#0B3C5D] mb-8 tracking-tight">POPIA Compliance</h1>
          <div className="prose prose-lg text-gray-700 max-w-none">
            <p><strong>Last Updated: {new Date().toLocaleDateString()}</strong></p>
            <p>Energy Warehouse is fully committed to compliance with the Protection of Personal Information Act (POPIA) of South Africa.</p>
            
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">1. Data Processing Principles</h2>
            <p>Dummy text for POPIA compliance. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">2. Your Rights under POPIA</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">3. Contacting our Information Officer</h2>
            <p>Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Email: compliance@ew.energy</p>
