...
export default function HeroSection({ 
  ...
  return (
    <div
      className="relative w-full min-h-screen flex items-center justify-start pt-24 pb-8 md:pt-24 md:pb-0 px-6 overflow-hidden"
    >
      ...
      >
        <div className="flex flex-col items-start text-left gap-3 md:gap-6 max-w-3xl pointer-events-none mt-2 md:mt-0">
          <motion.div
            variants={itemVariants}
            className="flex flex-wrap items-center gap-2.5"
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 md:px-4 md:py-1.5 rounded-full bg-white/10 border border-white/10 backdrop-blur-md">
            ...
            <a 
              ...
              className="inline-flex items-center gap-2 px-3 py-1 md:px-4 md:py-1.5 rounded-full bg-white/10 border border-white/10 backdrop-blur-md hover:bg-white/20 transition-all pointer-events-auto cursor-pointer"
            >
              <span className="w-2 h-2 rounded-full bg-[var(--color-accent)] animate-pulse" />
              <span className="text-white/90 text-xs md:text-sm font-medium tracking-wide flex items-center gap-2">
                Affiliated with <img src="/nearby-electrician.svg" alt="Nearby Electrician" className="h-4 md:h-6 w-auto" />
              </span>
              <ArrowUpRight size={14} className="text-white/90 md:w-4 md:h-4" />
            </a>
          </motion.div>

          <h1 className="text-2xl sm:text-4xl lg:text-6xl font-extrabold text-white leading-tight md:leading-[1.05] tracking-tight drop-shadow-2xl mt-0 md:mt-2">
          ...
          <motion.p
            variants={itemVariants}
            className="text-xs sm:text-lg md:text-xl text-white/90 max-w-xl leading-relaxed font-light drop-shadow-lg mt-1 md:mt-6"
          >
          ...
          <motion.div
            variants={itemVariants}
            className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center w-full gap-2.5 md:gap-4 mt-4 md:mt-6"
          >
            <a
            ...
            <button
              className="w-full sm:w-auto justify-center px-6 py-2.5 md:px-8 md:py-3.5 bg-white/10 backdrop-blur-md border border-white/20 text-white rounded-full text-xs md:text-sm font-semibold hover:bg-white/20 transition-all duration-300 flex items-center gap-2 transform hover:scale-[1.02] pointer-events-auto"
              onClick={(e) => {
                e.stopPropagation();
            ...
            <button
              className="w-full sm:w-auto justify-center px-6 py-2.5 md:px-8 md:py-3.5 bg-white/10 backdrop-blur-md border border-white/20 text-white rounded-full text-xs md:text-sm font-semibold hover:bg-white/20 transition-all duration-300 flex items-center gap-2 transform hover:scale-[1.02] pointer-events-auto shadow-lg shadow-black/10 cursor-pointer"
              onClick={(e) => {
                e.stopPropagation();
                if (onFreeDownloadClick) {
                  onFreeDownloadClick();
                }
              }}
            >
